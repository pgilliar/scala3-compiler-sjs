...
class Driver {
   ...
   *  @return
   */
  final def process(args: Array[String], simple: interfacessjs.SimpleReporter | Null,
    callback: interfacessjs.CompilerCallback | Null): interfacessjs.ReporterResult = {
  ...
  final def process(args: Array[String], reporter: Reporter | Null = null,
    callback: interfacessjs.CompilerCallback | Null = null): Reporter = {
  ...
  def process(args: Array[String]): Reporter =
    process(args, null: Reporter | Null, null: interfacessjs.CompilerCallback | Null)
  ...
  private def mainResult(args: Array[String]): Int = {
